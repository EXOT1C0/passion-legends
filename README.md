...
The eleven fighters use unique animated 2D canvas sprite models. All models are generated by `game.js`, so no image folder or external art files are required.
